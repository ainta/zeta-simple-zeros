...
\title{More than 67.3\% of the zeros of the Riemann zeta function are simple and lie on the critical line}
\date{}
...
\[
 ...
 \ge
 \frac{1{,}345{,}000H_{\mathrm{MT}}-2{,}680}{1{,}340{,}003}
...
\begin{equation}\label{eq:F6bound}
 \mathcal F_6(g_1,\ldots,g_6)\ge\frac{19}{5000}.
\end{equation}
\end{proposition}
...
of mesh $1/4000$.  If $\sum g_i\ge11.4$, the linear term proves the claim.
...
precision $128$ bits, $707{,}901$ visited nodes, and maximum depth $37$.
...
\begin{equation}\label{eq:mA}
 m:=269,
 \qquad
 A_0:=\frac{19}{5000}(m-6)=\frac{4997}{5000}<1.
\end{equation}
Let $B$ be a block of $269$ consecutive retained simple zeros.  Write $G_B$
...
\end{equation}
For each of the $m=269$ offsets, partition the ordered points into full
...
\begin{equation}\label{eq:defect-numbers}
 \cD(M^\circ)
 \ge
 \frac{4997}{1{,}345{,}000}N_0^s(T,2T)
 -\frac{268}{134{,}500}N(T,2T)-o(N(T,2T)).
\end{equation}
...
\begin{align*}
 ...
 +\frac{4997}{1{,}345{,}000}N_0^s(T,2T)\\
 &\qquad-\frac{268}{134{,}500}N(T,2T)-o(N(T,2T)).
\end{align*}
Hence
\[
 \left(1-\frac{4997}{1{,}345{,}000}\right)N_0^s(T,2T)
 \ge
 \left(H_{\mathrm{MT}}-\frac{268}{134{,}500}\right)N(T,2T)
 -o(N(T,2T)).
\]
